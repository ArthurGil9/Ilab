      ...
      <article id="projectPage" class="project project--hidden">
        <div class="project__context">
          <div class="project__details">
            <p id="projectOption" class="text">Option</p>
            <p class="text"><span id="projectType">Type de projet</span> <span id="projectYear">20XX</span></p>
            <div class="project__details--timing">
              ...
              <p id="projectDuration" class="text">Durée</p>
            </div>
          </div>

          <div class="project__desc">
            <h2 id="projectTitle" class="title">Titre du projet</h2>
            <p id="projectDesc" class="text text--big">Description du projet</p>
          </div>
          
          <ul id="projectPrograms" class="project__proglist">
            <!-- <li class="project__progel text">
              <img class="svg__progel" src="" alt="">
               Photoshop
            </li> -->
          </ul>
